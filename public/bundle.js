    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p2 = element("p");
    			t23 = text(t23_value);
    			add_location(h1, file, 116, 1, 2507);
    			add_location(b0, file, 120, 6, 2582);
    			attr_dev(label0, "for", "");
    			add_location(label0, file, 119, 4, 2561);
    			attr_dev(input0, "id", "language-vi");
    			attr_dev(input0, "type", "radio");
    			input0.__value = "vi";
    			input0.value = input0.__value;
    			/*$$binding_groups*/ ctx[10][0].push(input0);
    			add_location(input0, file, 124, 6, 2657);
    			attr_dev(label1, "for", "language-vi");
    			add_location(label1, file, 123, 4, 2625);
    			attr_dev(input1, "id", "language-en");
    			attr_dev(input1, "type", "radio");
    			input1.__value = "en";
    			input1.value = input1.__value;
    			/*$$binding_groups*/ ctx[10][0].push(input1);
    			add_location(input1, file, 129, 6, 2824);
    			attr_dev(label2, "for", "language-en");
    			add_location(label2, file, 128, 4, 2792);
    			attr_dev(div0, "align", "center");
    			add_location(div0, file, 118, 2, 2536);
    			add_location(b1, file, 136, 6, 3022);
    			attr_dev(label3, "for", "");
    			add_location(label3, file, 135, 4, 3001);
    			attr_dev(input2, "id", "vehicle-motobike");
    			attr_dev(input2, "type", "radio");
    			input2.__value = "motobike";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[10][1].push(input2);
    			add_location(input2, file, 140, 6, 3101);
    			attr_dev(label4, "for", "vehicle-motobike");
    			add_location(label4, file, 139, 4, 3064);
    			attr_dev(input3, "id", "vehicle-auto");
    			attr_dev(input3, "type", "radio");
    			input3.__value = "auto";
    			input3.value = input3.__value;
    			/*$$binding_groups*/ ctx[10][1].push(input3);
    			add_location(input3, file, 145, 6, 3280);
    			attr_dev(label5, "for", "vehicle-auto");
    			add_location(label5, file, 144, 4, 3247);
    			attr_dev(div1, "align", "center");
    			attr_dev(div1, "class", "mt-1 svelte-8tkvga");
    			add_location(div1, file, 134, 2, 2963);
    			add_location(br, file, 152, 16, 3527);
    			...
    			add_location(button0, file, 157, 4, 3602);
    			attr_dev(button1, "class", "svelte-8tkvga");
    			add_location(button1, file, 160, 4, 3675);
    			attr_dev(p1, "align", "center");
    			attr_dev(p1, "class", "mt-1 svelte-8tkvga");
    			add_location(p1, file, 156, 2, 3566);
    			attr_dev(p2, "class", "mt-1 svelte-8tkvga");
    			add_location(p2, file, 165, 2, 3754);
    			attr_dev(main, "class", "svelte-8tkvga");
    			add_location(main, file, 115, 0, 2499);
    		},
